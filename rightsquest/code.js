const config = {
	apiKey: "AIzaSyBaqjLPeWYbxSPymnyXaE-ADbBqkSYXEOo",
	authDomain: "rights-quest.firebaseapp.com",
	projectId: "rights-quest",
	storageBucket: "rights-quest.appspot.com",
	messagingSenderId: "1063434673930",
	appId: "1:1063434673930:web:ff489236ea1c398b2be4f3",
	measurementId: "G-SZ38PPD52Y",
	databaseURL: "https://rights-quest-default-rtdb.firebaseio.com/",
  };
...
function mathsub(){
	localStorage.setItem('subject', "equality");
}
function astrosub(){
	localStorage.setItem('subject', "freedom");
}
function physub(){
	localStorage.setItem('subject', "education");
}
function chesub(){
	localStorage.setItem('subject', "exploitation");
}